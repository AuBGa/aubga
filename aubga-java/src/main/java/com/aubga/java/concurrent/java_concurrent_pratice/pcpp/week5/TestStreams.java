package com.aubga.java.concurrent.java_concurrent_pratice.pcpp.week5;// A Java 8 streams (non-concurrent) version of the concurrent
...
public class TestStreams {
    ...
    private static Stream<Webpage> makeWebPageOrNone(String url, int maxLines) {
        try {
            return Stream.of(new Webpage(url, getPage(url, maxLines)));
