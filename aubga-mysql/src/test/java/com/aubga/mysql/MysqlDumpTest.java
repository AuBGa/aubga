...
public class MysqlDumpTest {  
    ...
    public static void main(String args[]) throws IOException {  
     //   InputStream is = MysqlDumpTest.class.getClassLoader().getResourceAsStream("jdbc.properties");  
        Properties properties = new Properties();  
       // properties.load(is);  
        MysqlDumpTest.export(properties);//这里简单点异常我就直接往上抛  
    }  
...
*/        
        ...
        String exportDatabaseName = "aubga";
        String host = "10.103.27.225";
        String port = "3306";  
        String exportPath = "D\\:\\allinone\\dbName.sql";
