...
public class Chapter07 {
	...
	private String zsetCommon(Transaction trans, String method, int ttl, ZParams params, String... sets) {
		...
		String id = UUID.randomUUID().toString();
		try {
			trans.getClass().getDeclaredMethod(method, String.class, ZParams.class, String[].class).invoke(trans,
					"idx:" + id, params, keys);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public void updateCpms(Jedis conn, String adId) {
		...
		AVERAGE_PER_1K.put(ecpm, 1000. * Integer.valueOf(typeClicks != null ? typeClicks : "1")
